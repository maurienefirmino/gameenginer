...
public class Tile {
	...
	public static BufferedImage TILE_TREE = Game.objetcsSpriteSheet.getSprite(32, 0, 16, 16);
	public static BufferedImage TILE_LIFE = Game.objetcsSpriteSheet.getSprite(48, 0, 16, 16);
